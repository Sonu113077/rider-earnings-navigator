...
import { Clock, FileText, Settings, User } from 'lucide-react';

interface Activity {
  id: string;
  type: 'user_update' | 'system_update' | 'payment_update' | 'rider_data';
  title: string;
  description: string;
  timestamp: Date;
}
        ...
        {isLoading ? (
          ...
          <div className="space-y-1 divide-y">
            {activities.map((activity) => (
              <div key={activity.id} className="flex items-start py-3 group">
